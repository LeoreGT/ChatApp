...
Map_Result HashMap_Remove(HashMap* _map, const void* _searchKey, void** _pValue)
{
	...
	pthread_mutex_lock(&_map->m_mutex);
	iter = KeyItemFoundInList(list, (void*)_searchKey, _map->m_equalityFunction);
